...
import {
  OperationTypeEmits,
  OperationTypeProps
} from '@/projects/cashier/features/five-three-operation/buyer/operation-buyer.types';
import useOperationBuyer from '@/projects/cashier/features/five-three-operation/buyer/useOperationBuyer';
