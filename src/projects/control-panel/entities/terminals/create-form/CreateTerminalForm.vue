...
import type {
  CreateTerminalFormEmits,
  CreateTerminalFormProps
} from './create-terminal-form.types';
import useCreateTerminalForm from './useCreateTerminalForm';

const props = defineProps<CreateTerminalFormProps>();
const emit = defineEmits<CreateTerminalFormEmits>();
...
} = useCreateTerminalForm(props, emit);
