...
import useTransactionFilterModal from '@/projects/autopay/entities/transaction/transaction-filter-modal/useTransactionFilterModal';

const props = defineProps<ITransactionFilterModalProps>();
const emit = defineEmits<ITransactionFilterModalEmits>();
...
const {
  ...
  formRef,
  maskOptions
} = useTransactionFilterModal(props, emit);
</script>
