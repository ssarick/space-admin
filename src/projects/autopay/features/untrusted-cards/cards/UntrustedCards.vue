...
import UntrustedCardsFilterModal from '@/projects/autopay/entities/untrusted-card/untrusted-card-filter-modal/UntrustedCardsFilterModal.vue';
import UntrustedCardList from '@/projects/autopay/entities/untrusted-card/untrusted-card-list/UntrustedCardList.vue';
import useUntrustedCards from './useUntrustedCards';
...
<template>
  <div>
    ...
    >
      <PageTitle
        no-margin
        :title="`${$t('card-untrusted-list-wrapper')} Genesis`"
      />
